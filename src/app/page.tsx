      ...
      <main className="flex-1">
        ...
        <section className="relative h-[90vh] min-h-[700px] w-full bg-black flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center px-4 max-w-5xl mx-auto flex flex-col items-center">
            <div className="inline-block mb-6 px-4 py-1.5 rounded-full border border-white/20 bg-white/10 backdrop-blur-md text-white text-[10px] sm:text-xs font-bold uppercase tracking-[0.3em] animate-fade-in">
              New Collection 2024
            </div>
            <h1 className="text-5xl sm:text-7xl lg:text-8xl font-black text-white mb-8 uppercase tracking-tighter leading-[0.9] animate-slide-up">
              Elevate Your <br />
              <span className="text-accent italic font-light drop-shadow-[0_2px_15px_rgba(212,175,55,0.3)]">Everyday</span> Style
            </h1>
            <p className="text-base sm:text-xl text-gray-300 mb-12 max-w-2xl text-balance font-light leading-relaxed animate-fade-in delay-200">
              Premium Moroccan streetwear designed for the bold. Experience comfort without compromise. Quick WhatsApp ordering with free nationwide delivery.
            </p>
          ...
          <div className="container mx-auto px-6">
            <ScrollReveal>
              <div className="flex flex-col items-center mb-16">
                <span className="text-accent text-xs font-bold uppercase tracking-[0.3em] mb-3">Collections</span>
                <h2 className="text-4xl font-black tracking-tighter uppercase italic">Shop by Category</h2>
              </div>
            </ScrollReveal>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              ...
              <ScrollReveal delay={100}>
                <Link href="/shop?category=women" className="group relative h-[500px] overflow-hidden rounded-[2.5rem] flex items-end p-10 shadow-2xl block">
                  ...
                  <div className="relative z-10 w-full flex justify-between items-center group-hover:translate-x-2 transition-transform duration-500">
                    <div>
                      <h2 className="text-4xl font-black text-white mb-2 uppercase tracking-tighter italic">Women</h2>
                      <p className="text-gray-300 text-sm font-medium">Curated Elegance</p>
                    </div>
              ...
              <ScrollReveal delay={200}>
                <Link href="/shop?category=men" className="group relative h-[500px] overflow-hidden rounded-[2.5rem] flex items-end p-10 shadow-2xl block">
                  ...
                  <div className="relative z-10 w-full flex justify-between items-center group-hover:translate-x-2 transition-transform duration-500">
                    <div>
                      <h2 className="text-4xl font-black text-white mb-2 uppercase tracking-tighter italic">Men</h2>
                      <p className="text-gray-300 text-sm font-medium">Street Sophistication</p>
                    </div>
                    <div className="w-14 h-14 rounded-full bg-white flex items-center justify-center group-hover:bg-accent transition-colors shadow-xl">
                      <span className="text-black text-xl font-bold">&rarr;</span>
                    </div>
        ...
        <section className="py-16 bg-[#F9F9F9] border-y border-gray-100">
          <div className="container mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
            {[
              { title: "Free Shipping", desc: "Across all Moroccan cities", icon: Truck },
              { title: "Premium Quality", desc: "Handpicked materials", icon: Sparkles },
              { title: "WhatsApp Support", desc: "Instant response daily", icon: Phone },
              { title: "Easy Returns", desc: "7-day exchange policy", icon: RefreshCcw }
            ].map((benefit, i) => (
            ...
            <ScrollReveal>
              <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
                <div className="max-w-xl">
                  <span className="text-accent text-xs font-bold uppercase tracking-[0.3em] mb-3 inline-block">Trending Now</span>
                  <h2 className="text-4xl font-black tracking-tighter uppercase italic leading-tight">Elite Pieces <br /> You Can&apos;t Miss</h2>
                </div>
            ...
            <ScrollReveal>
              <div className="flex flex-col items-center mb-16 text-center">
                ...
                <h2 className="text-4xl font-black tracking-tighter uppercase italic leading-[1.1] max-w-xl">
                  The Community <br /> We&apos;re Building Together
                </h2>
              </div>
            </ScrollReveal>
        ...
        <section className="py-32 relative overflow-hidden bg-black flex items-center justify-center">
          ...
          <ScrollReveal className="relative z-10 container mx-auto px-6 max-w-4xl text-center flex flex-col items-center">
            ...
            <h2 className="text-5xl md:text-7xl font-black mb-8 text-white uppercase tracking-tighter leading-tight">
              Sale of <br /> the <span className="text-accent italic font-light">Season</span>
            </h2>
            <p className="text-lg md:text-xl text-gray-300 mb-12 text-balance leading-relaxed font-light">
              Don&apos;t miss our exclusive 40% discount on selected streetwear. Limited stock available. Direct WhatsApp ordering for instant confirmation.
            </p>
            <Link 
              href="/shop?category=promotions" 
